...
namespace PizzaRestaurant.Persistence.Migrations
{
    ...
    [Migration("20230126182938_addIsDeletedToAddress")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PizzaRestaurnat.Domain.RankHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PizzaRestaurnat.Domain.Pizzas.Pizza", b =>
                {
                    b.HasOne("PizzaRestaurnat.Domain.Image", "Image")
                        .WithOne("Pizza")
                        .HasForeignKey("PizzaRestaurnat.Domain.Pizzas.Pizza", "ImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
